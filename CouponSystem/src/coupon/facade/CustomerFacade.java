...
public class CustomerFacade implements CouponClientFacade {
    ...
    public Set<Coupon> getAllCouponsByTypeHistorically(CouponType couponType) throws DaoException {
        ...
        Set<Coupon> allPurchasedByType = null;
    ...
    public Set<Coupon> getAllCouponsBPriceHistorically(double couponPrice) throws DaoException {
        Customer customer = this.customer;
        Set<Coupon> allPurchased = getAllPurchasedCoupons();
        Set<Coupon> allPurchasedByPrice = null;
        Iterator it = allPurchased.iterator();
    ...
    public static Customer customerLogin(String username, String password) throws LoginException {
        CustomerDBDAO customerDBDAO = new CustomerDBDAO();
        try {
