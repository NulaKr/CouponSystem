...
public class CustomerDBDAO implements CustomerDAO {
    ...
    public Set<Coupon> getCoupons(long customerId) throws DBConnectionException, DaoException {
        ...
        String getCoupons = "SELECT * from coupon INNER JOIN Join_Customer_Coupon ON coupon.ID = Join_Customer_Coupon.COUPON_ID " +
                "WHERE Join_Customer_Coupon.CUST_ID=" + customerId;
