...
public class CouponDBDAO implements CouponDAO {
    ...
    public void createCoupon(Coupon coupon, Company company) throws DaoException, DBConnectionException {
        ...
        String coupomCompany = "INSERT into Join_Company_Coupon (COMP_ID, COUPON_ID) VALUES (?, ?)";
        try {
            ...
            // Add coupon to the Join_Company_Coupon table
            PreparedStatement pstm2 = con.prepareStatement(coupomCompany);
